...
--
-- Host: localhost
-- Generation Time: Oct 02, 2014 at 08:24 AM
...
--
-- Dumping data for table `enquiry_course_interested`
--

INSERT INTO `enquiry_course_interested` (`id`, `enquiry_id`, `course_interested`, `country_id`) VALUES
(1, 1, 'MBA', 13),
(2, 1, 'dddeeeeee', 1),
(3, 2, '3232', 14),
(4, 3, 'MBAsss', 1);
...
INSERT INTO `enquiry_master` (`id`, `user_id`, `date`, `enquiry_mode`, `first_name`, `last_name`, `address`, `state`, `country_id`, `pincode`, `email_id`, `phone_no`, `source`, `source_description`, `discription`) VALUES
(3, 1, '2014-10-02 00:00:00', 1, 'Manaf', 'PM', 'sas', 'Thrissur District, Kerala', 84, 680685, 'manaftvm@gmail.com', '(999) 543-6207', 1, '', 'asa');
...
--
-- Dumping data for table `enqury_test_prepare`
--

INSERT INTO `enqury_test_prepare` (`id`, `enquiry_id`, `toffel`, `ielts`, `gmat`, `gre`, `sat`, `started_coaching`, `looking_for_coaching`, `looking_for_waier`, `regular_or_fast_track`, `work_experiance`) VALUES
(1, 1, 55, 0, 67, 44, 0, 1, 1, 1, 'fasttrack', 'zzxxxx');
...
--
-- Dumping data for table `enruiry_education`
--

INSERT INTO `enruiry_education` (`id`, `enquiry_id`, `country_id`, `qualification`, `board`, `institution`, `passout_year`, `percentage`) VALUES
(1, 1, 3, 'bcom', 'calicut', 'kerala', 2009, 90),
(2, 2, 14, 'bcom', 'Board of Technical Education', 'ccc', 2009, 90),
(3, 3, 14, 'bcom', 'Board of Technical Education', 'ccc', 2009, 90);
