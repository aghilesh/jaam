...
<ul class="fl form-fields-ul-slider">
    ...
    <li class="fl form-field">
        <?php echo form_dropdown('publicity_source', $publicity_sources,$post['publicity_source'],'id="publicity_source" class="generic-input" onChange="Registration.toggleDescription(this)" ');?>
    </li>
    <li class="clear newline"/>
