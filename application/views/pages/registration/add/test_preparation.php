...
?>
    ...
    <li class="fl form-field">
             <?php
            $testPrepStartCoachingYes = $post['testPrepStartCoaching'];
    ...
    <li class="fl form-field">
            <?php
            $testPrepLookForCoachingYes = $post['testPrepLookForCoaching'];
            $testPrepLookForCoachingNo = !$testPrepStartCoachingYes;
            ?>
           <input class="" <?php echo $testPrepLookForCoachingYes ? 'checked' : ''?> type="radio" name="testPrepLookForCoaching" id="testPrepLookForCoachingYes" value="1"/><label for="testPrepLookForCoachingYes">Yes</label>
           <input class="" <?php echo $testPrepLookForCoachingNo ? 'checked' : ''?> type="radio" name="testPrepLookForCoaching" id="testPrepLookForCoachingNo" value="0"/><label for="testPrepLookForCoachingNo">No</label>
    </li>
    <li class="clear newline"/>
    ...
    <li class="fl form-field">
            <?php
            $testPrepLookForWaierYes = $post['testPrepLookForWaier'];
            $testPrepLookForWaierNo = !$testPrepStartCoachingYes;
            ?>
