<div class="fl full-width">
    <div class="form-inner">
        ...
        <ul class="fl form-fields-ul-slider">
            ...
            <li class="fl form-field"><input class="generic-input" type="text" name="university" id="university" placeholder="University"/></li>
            <li class="clear newline"/>
            ...
            <li class="fl form-field"><input class="generic-input" type="text" name="contact_person" id="contact_person" placeholder="Contact Person"/></li>
            <li class="clear newline"/>

            <li class="fl form-label">Address</li>
            <li class="fl form-field"><input class="generic-input" type="text" name="address" id="address" placeholder="Address"/></li>
            <li class="clear newline"/>
        ...
        <ul class="fl form-fields-ul-slider">
            ...
            <li class="fl form-field"><input class="generic-input" type="text" name="email_id" id="email_id" placeholder="Email"/></li>
            <li class="clear newline"/>
            
            <li class="fl form-label">Phone 1</li>
            <li class="fl form-field"><input class="generic-input" type="text" required name="phone1" id="phone1" placeholder="Phone 1"/></li>
            <li class="clear newline"/>

            <li class="fl form-label">Phone 2</li>
            <li class="fl form-field"><input class="generic-input" type="text" name="phone2" id="phone2" placeholder="Phone 2"/></li>
            <li class="clear newline"/>

            <li class="fl form-label">Commission %</li>
            <li class="fl form-field"><input class="generic-input" type="text" name="commission_percentage" id="commission_percentage" placeholder="Commission %"/></li>
            <li class="clear newline"/>

            <li class="fl form-label">Application Fee</li>
            <li class="fl form-field"><input class="generic-input" type="text" name="application_fee" id="application_fee" placeholder="Application Fee"/></li>
            <li class="clear newline"/>

            <li class="fl form-label">Service Charge</li>
            <li class="fl form-field"><input class="generic-input" type="text" name="service_charge" id="service_charge" placeholder="Service Charge"/></li>
            <li class="clear newline"/>
