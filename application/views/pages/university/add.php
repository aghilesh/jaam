<div class="fl full-width generic-add-form-container">
    <h3 class="generic-add-form-title full-width fl">Add University</h3>
    ...
    <ul class="fl form-fields-ul-slider marginleft20">
        ...
        <li class="fl form-field" sty>
            <a href="javascript:void(0)" class="fl button blue common-save-btn-click">SAVE</a>
            <a href="javascript:void(0)" class="fl marginleft10 button blue common-cancel-btn-click">CANCEL</a>
        </li>
        <li class="clear newline"/>
    </ul>
</div>