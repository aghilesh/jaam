...
<div class="fl full-width">
    <div class="form-inner">
        ...
        <ul class="fl form-fields-ul-slider">
            ...
            <li class="fl form-field"><input class="generic-input validate validate-mandatory" type="text" name="university" id="university" placeholder="University" value="<?php echo $post['university']?>"/></li>
            <li class="clear newline"/>
