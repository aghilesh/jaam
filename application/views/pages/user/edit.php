<div class="fl full-width">
    <div class="form-inner">
        ...
        echo form_open($paths['edit'].'/'.@$user->id, $attributes);
        ?>
        <ul class="fl form-fields-ul-slider">
            <li class="fl form-label">First Name</li>
            <li class="fl form-field"><input value="<?php echo @$user->first_name;?>" class="generic-input" type="text" required name="first_name" id="first_name" placeholder="First Name"/></li>
            <li class="clear newline"/>

            <li class="fl form-label">Last Name</li>
            <li class="fl form-field"><input value="<?php echo @$user->last_name;?>" class="generic-input" type="text" name="last_name" id="last_name" placeholder="Last Name"/></li>
            <li class="clear newline"/>
            
            <li class="fl form-label">Email</li>
            <li class="fl form-field"><input value="<?php echo @$user->email_id;?>" class="generic-input" type="text" name="email" id="email" placeholder="Email"/></li>
            <li class="clear newline"/>
            
            <li class="fl form-label">Phone</li>
            <li class="fl form-field"><input value="<?php echo @$user->phone_no;?>" class="generic-input" type="text" name="phone" id="phone" placeholder="Phone"/></li>
            <li class="clear newline"/>
        ...
        <ul class="fl form-fields-ul-slider">
            ...
            <li class="fl form-field"><input value="<?php echo @$user->user_name;?>" class="generic-input" type="text" name="user_name" id="user_name" placeholder="User Name"/></li>
            <li class="clear newline"/>
